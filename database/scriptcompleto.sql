-- checksum_sha256: b0e020c39b62d1908afcd20672092ac437777d62197633c372ddb256cc5f6916
-- IntegraRP scriptcompleto gerado deterministicamente para v1.15
CREATE SCHEMA IF NOT EXISTS integrarp;

-- =====================================================================
-- Migration: 0001_initial_integrarp.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0003_flow_bpmn_core.sql
-- =====================================================================
CREATE EXTENSION IF NOT EXISTS pgcrypto;
CREATE SCHEMA IF NOT EXISTS integrarp;
...
-- =====================================================================
-- Migration: 0004_flow_designer_web.sql
-- =====================================================================
CREATE EXTENSION IF NOT EXISTS pgcrypto;
...
-- =====================================================================
-- Migration: 0006_faturamento_connect_outbox.sql
-- =====================================================================
CREATE SCHEMA IF NOT EXISTS integrarp;
CREATE EXTENSION IF NOT EXISTS pgcrypto;
...
-- =====================================================================
-- Migration: 0007_bi_kpis_project_central.sql
-- =====================================================================
CREATE SCHEMA IF NOT EXISTS integrarp;
CREATE EXTENSION IF NOT EXISTS pgcrypto;
...
-- =====================================================================
-- Migration: 0008_mobile_ai_mvp.sql
-- =====================================================================
CREATE SCHEMA IF NOT EXISTS integrarp;
...
-- =====================================================================
-- Migration: 0009_studio_avancado_modulos_dinamicos.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0010_templates_operacionais_distribuicao_campo.sql
-- =====================================================================
CREATE EXTENSION IF NOT EXISTS pgcrypto;
...
-- =====================================================================
-- Migration: 0011_hardening_indexes_observability.sql
-- =====================================================================
CREATE SCHEMA IF NOT EXISTS integrarp;
...
-- =====================================================================
-- Migration: 0012_piloto_v1_final_adjustments.sql
-- =====================================================================
CREATE SCHEMA IF NOT EXISTS integrarp;
...
-- =====================================================================
-- Migration: 0013_v11_scriptcompleto_forms_automation.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0014_v12_integracoes_fiscal_conciliacao_rotas_offline.sql
-- =====================================================================
CREATE SCHEMA IF NOT EXISTS integrarp;
...
-- =====================================================================
-- Migration: 0014_v12_jornada_cliente_onboarding_ux.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0015_v13_funcionalidade_real_end_to_end.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0016_v14_postgres_repositories_operacional.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0017_v15_validacao_real_cruds_qa_deploy.sql
-- =====================================================================
-- =============================================================
...
-- =====================================================================
-- Migration: 0018_v16_release_candidate_validation.sql
-- =====================================================================
-- =============================================================
...
-- =====================================================================
-- Migration: 0019_v17_runtime_validation_and_green_pipeline.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0020_v18_funcionalidade_real_produto.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0020_v18_produto_funcional_cruds_telas_jornada.sql
-- =====================================================================
CREATE SCHEMA IF NOT EXISTS integrarp;
CREATE EXTENSION IF NOT EXISTS pgcrypto;
...
-- =====================================================================
-- Migration: 0021_v19_demo_funcional_inserts_telas_jornada.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0021_v19_fix_scriptcompleto_inserts_demo_jornada.sql
-- =====================================================================
-- IntegraRP database complete idempotent script v1.9
CREATE SCHEMA IF NOT EXISTS integrarp;
CREATE EXTENSION IF NOT EXISTS pgcrypto;
...
-- =====================================================================
-- Migration: 0023_v113_consolidacao_funcional_maturidade.sql
-- =====================================================================
...
-- =====================================================================
-- Migration: 0024_v114_consolidacao_operacional_seguranca.sql
-- =====================================================================
